...
The gain comes from reducing variance. Our model is complex enough being all interactions therefore are bias is sufficently low. To further improve our model is to reduce variance and that is done by bagging and it comes at no cost as it does not increase bias with a suffiecent H. This is why it is "better" then the unbagged model.
