...
It should be either 1 or 0 because catagories are mutually exclusive. We can only put an object into 1 category. None = 0
...
X[ , 6] = sample(c(rep(1, n * 0.24), rep(0, n * .76)))
X
fake_first_names = c(
...
* Randomly punch holes (i.e. `NA`) values in this matrix so that an each entry is missing approximately 30% of the entries are missing.
