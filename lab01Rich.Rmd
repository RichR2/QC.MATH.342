...
no because floating point error. discussed in class
...
```{r}
x_3 = sample(4, 100, replace = TRUE, prob = c(.25,.25,.25,.25))
factor(x_3, labels = c("none", "infraction", "misdeamoner", "felony"))
```

* Use `x_3` to create `x_3_bin`, a binary feature where 0 is no crime and 1 is any crime.

```{r}
x_3_bin = as.numeric(x_3)
ifelse(as.numeric(x_3 > 1), print(1), print(0))
...
```{r}
x_3_ord = ordered(x_3 , levels = c("none", "infraction", "misdemanor", "felony"), exclude = NA)
x_3_ord
```
